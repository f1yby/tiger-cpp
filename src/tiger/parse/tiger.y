...
%token
  COMMA COLON SEMICOLON LPAREN ASSIGN
  LBRACE RBRACE DOT
...
%type <exp> exp expseq arrexp
%type <explist> actuals nonemptyactuals sequencing sequencing_exps
%type <var> lvalue oneormore one
...
nonemptyactuals: exp COMMA nonemptyactuals { $3->Prepend($1); $$ = $3; }
...
rec_nonempty: rec_one COMMA rec_nonempty { $3->Prepend($1); $$ = $3; }
...
decs_nonempty: decs_nonempty_s decs_nonempty { $2->Prepend($1); $$ = $2; }
...
fundec: fundec_one fundec { $2->Prepend($1); $$ = $2; }
...
tydec: tydec_one tydec { $2->Prepend($1); $$ = $2; }
...
tyfields_nonempty: tyfield COMMA tyfields_nonempty { $3->Prepend($1); $$ = $3; }
...
sequencing: exp SEMICOLON sequencing { $3->Prepend($1); $$ = $3; }
  | exp { $$ = new absyn::ExpList($1); }
  ;
